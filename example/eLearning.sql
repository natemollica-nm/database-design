...
-- AUTHOR --
INSERT INTO `AUTHOR` (`AUTH_ID`, `AUTH_FN`, `AUTH_LN`, `AUTH_FULLN`)
VALUES ('2123', 'Paul J.', 'Deitel', 'Paul J. Deitel'),
       ('6544', 'Yashavant', 'Kanetkar', 'Yashavant Kanetkar'),
       ('6198', 'Charles', 'Bukowski', 'Charles Bukowski'),
       ('9879', 'Herbert', 'Schildt', 'Herbert Schildt');

-- PUBLISHER --
INSERT INTO `PUBLISHER` (`PUB_ID`, `PUB_NAME`, `PUB_ADDR`, `PUB_URL`)
VALUES ('00001', 'Prentice Hall', '15 E Midland Ave Ste 502 Paramus, NJ 07652', 'https://www.pearson.com'),
       ('00002', 'Tata Mcgraw', '3310, 1st Floor 8th Cross, H.A.L. II Stage, Indiranagar, Bangalore 560038',
...
-- BOOK --
INSERT INTO `BOOK` (`BK_ISBN`, `BK_INVID`, `BK_REQID`, `AUTH_ID`, `PUB_ID`, `BK_RENTCOST`, `BK_BUYCOST`, `BK_TITLE`,
                    `BK_EDITION`, `BK_URL`, `BK_CATEGORY`)
VALUES ('101', '1011', '2000001', '2123', '00001', '38.59', '122.54', 'Programming in Java - 101', '12',
        'https://elearning/prog-in-java-12', 'Computer Science'),
       ('223', '1022', '2000002', '6544', '00002', '44.58', '150.30', 'Understand Transact-SQL', '22',
        'https://elearning/under-trans-sql-22', 'Computer Science'),
       ('1201', '1033', '2000003', '6198', '00003', '35.69', '112.45', 'Where the Wild Things Are', NULL,
        'https://elearning/fiction/wtwta', 'Childrens'),
       ('0231', '1044', '2000004', '9879', '00004', '65.99', '250.69', 'Ham on Rye', NULL,
        'https://elearning/fiction/ham-rye-bukowski', 'Classics');

-- eLEARNING --
INSERT INTO `eLEARNING` (`SYS_ID`, `SYS_BILLING`, `SYS_REQRESPONSE`, `SYS_URL`)
VALUES ('72345', 'eLEARNING BILL INFO', NULL, 'https://elearning');

-- LIBRARY --
INSERT INTO `LIBRARY` (`LIB_ID`, `LIB_QRESULTS`, `LIB_URL`)
VALUES ('666999', NULL, 'https://elearning/library');

-- LIB_INVENTORY --
INSERT INTO `LIB_INVENTORY` (`INV_ID`, `INV_LASTUPDATE`)
VALUES ('666999', '2022-03-24 00:00:23');

-- E_COURSE --
INSERT INTO `E_COURSE` (`E_CID`, `E_REQID`, `E_INVID`, `E_CONTENT`, `ECOURSE_NAME`, `ECOURSE_START`, `ECOURSE_END`,
                        `E_NUMOF_STUD`)
VALUES ('262', '2000001', '2011', '<JAVA_CONTENT>', 'Programming in Java', '2022-04-11 00:00:00', '2022-04-29 12:00:00',
        '16'),
       ('440', '2000002', '2022', '<DATABASE_CONTENT>', 'Database Modeling & Design', '2022-04-04 00:00:00',
        '2022-04-29 12:00:00', '22'),
       ('261', '2000003', '2033', '<C++_CONTENT>', 'Programming in C++', '2022-04-11 00:00:00', '2022-04-29 12:00:00',
        '31'),
       ('220', '2000004', '2044', '<PROPS_STATS_CONTENT>', 'Applied Probability & Statistics', '2022-04-11 00:00:00',
        '2022-04-29 12:00:00', '29');

-- E_MEMBERSHIP --
INSERT INTO `E_MEMBERSHIP` (`MEM_SYSID`, `MEM_STUDID`, `MEM_STAFFID`, `MEM_UNIID`, `MEM_ACTIVE`, `MEM_START`,
                            `MEM_EXPIRATION`, `MEM_TERMS`)
VALUES ('1', '11', '1011', '6711', 1, '2019-02-24 00:00:23', '2025-02-24 00:00:23', NULL),
